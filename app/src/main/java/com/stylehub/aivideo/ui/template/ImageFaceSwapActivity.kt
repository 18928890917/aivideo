 ...
 */
class ImageFaceSwapActivity : BaseSwapActivity<ImageFaceSwapActivityViewModel, ImageFaceSwapActivityData>() {
    override val mViewModel: ImageFaceSwapActivityViewModel by viewModels()
